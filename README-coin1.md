...
### Check metric to see if message is delivered

```
curl 127.0.0.1:9096/metrics
# check for entry like this
# hyperlane_operations_processed_count{agent="relayer",chain="aptoslocalnet2",hyperlane_baselib_version="0.1.0",phase="confirmed"} 1
# when sending message from chain 1->2
```
